...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    sayColor: function sayColor(color) {
      if (color == 'theme-light') return 'Lightness';else if (color == 'theme-dark') return 'Darkness';
...
var render = function() {
  ...
  return _c(
    "modal",
    {
      attrs: {
        name: "new-project",
        classes: "p-10 bg-card rounded-lg text-default",
        height: "auto"
      }
    },
    [
          ...
          _c("div", { staticClass: "flex" }, [
            ...
            _c("div", { staticClass: "flex-1 ml-4" }, [
              ...
              _c(
                "button",
                {
                  staticClass: "inline-flex items-center text-xs icon-theme",
                  attrs: { type: "button" },
      ...
      _c("footer", { staticClass: "flex justify-end" }, [
        ...
        _c(
          "button",
          { staticClass: "button ml-3", on: { click: _vm.submit } },
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "mr-10 flex items-center" },
    _vm._l(_vm.themes, function(color, theme) {
      return _c("button", {
        ...
        attrs: { title: _vm.sayColor(theme) },
        on: {
          click: function($event) {
...
__webpack_require__(/*! C:\laragon\www\andsolucion\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\andsolucion\resources\sass\app.scss */"./resources/sass/app.scss");
